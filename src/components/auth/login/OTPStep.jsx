...
export default function OTPStep({ otp, setOtp, email, setCurrentStep }) {
  ...
  return (
    ...
    >
      ...
      {/* OTP Input */}
      <div className="space-y-4">
        <label className="block font-normal font-poppins">Enter OTP</label>
        <div className="flex justify-center">
          ...
          >
            <InputOTPGroup className="flex justify-center gap-6">
              <InputOTPSlot
                index={0}
                className="w-14 h-14 text-lg font-normal border-2 border-gray-300 rounded-lg bg-[#E7EEFF]"
              />
              <InputOTPSlot
                index={1}
                className="w-14 h-14 text-lg font-normal border-2 border-gray-300 rounded-lg  bg-[#E7EEFF]"
      ...
      <motion.button
        ...
        className="w-full py-3 px-4 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
