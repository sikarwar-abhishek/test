...
function LoginForm({ setCurrentStep, form }) {
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="text-center space-y-2 mb-8">
            <h1 className="text-3xl font-poppins font-bold">Get Started</h1>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <motion.button
              ...
              whileHover={!isLogging ? { scale: 1.02 } : {}}
              whileTap={!isLogging ? { scale: 0.98 } : {}}
              animate={isLogging ? { scale: [1, 1.02, 1] } : {}}
              transition={
                isLogging
